...
func init() {
	...
	dsaPubKey.P, _ = new(big.Int).SetString("{{printf "%x" .DSA.P}}", 16)
	dsaPubKey.Q, _ = new(big.Int).SetString("{{printf "%x" .DSA.Q}}", 16)
	dsaPubKey.G, _ = new(big.Int).SetString("{{printf "%x" .DSA.G}}", 16)
	dsaPubKey.Y, _ = new(big.Int).SetString("{{printf "%x" .DSA.Y}}", 16)
